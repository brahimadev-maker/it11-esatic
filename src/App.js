...
const Hero = () => {
  ...
  return (
    <section id="accueil" style={{ minHeight: "100vh", display: "flex", alignItems: "center", position: "relative", overflow: "hidden", padding: isMobile ? "100px 20px 60px" : isTablet ? "120px 32px 70px" : "130px 56px 70px", background: C.bg, fontFamily: "'Outfit',sans-serif" }}>
      ...
      {!isTablet && (
        <>
          {/* Bulle de dialogue du président */}
          <div style={{
            position: "absolute",
            right: 375,
            top: "24%",
            ...
            padding: "16px 20px",
            borderRadius: 20,
            boxShadow: "0 15px 35px rgba(10,22,40,0.08)",
            border: "1px solid rgba(26,108,232,0.1)",
            maxWidth: 320,
            ...
            <div style={{ display: "flex", gap: 10, marginBottom: 8, alignItems: "center" }}>
              <div style={{
                ...
                boxShadow: "0 0 0 3px rgba(232,18,44,0.2)"
              }} />
              <span style={{ fontSize: 10, fontWeight: 800, color: C.red, letterSpacing: 1.5, textTransform: "uppercase" }}>
                Mot du Président
              </span>
            </div>
            ...
            <div style={{
              ...
              height: 14,
              background: "#fff",
              borderRight: "1px solid rgba(26,108,232,0.1)",
              borderTop: "1px solid rgba(26,108,232,0.1)",
              zIndex: -1
            }} />
          </div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              height: "100%",
              background: C.light,
              border: "2px dashed rgba(26,108,232,.2)",
              overflow: "hidden",
              position: "relative",
            }}>
              {right && (
          ...
          <div style={{ display: "inline-flex", background: "rgba(26,108,232,.07)", borderRadius: 40, padding: 4, marginBottom: 40, gap: 4 }}>
            {filtres.map(f => (
              <button key={f} onClick={() => setFiltre(f)}
                style={{
                  padding: "7px 20px", borderRadius: 36, border: "none", cursor: "pointer", fontSize: 12, fontWeight: 700, letterSpacing: .5, transition: "all .2s", fontFamily: "'Outfit',sans-serif",
